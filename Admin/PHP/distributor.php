        ...
        <div class="content" id="">
			...
			?>
                ...
                <div class="path">
                    ...
                    <div class="btn">
                        <a href="distributor_request.php"><img src="images/icons/plus.png" />Requests</a>
                    </div>
                </div>
                <div class="main">
                    <div class="tbl_head">
                    ...
                    <div class="tbl">
                        <table>
                            ...
                            if(isset($_POST['info']))
                            {
                                ...
                                echo "<script>window.location.href='distributor_info.php';</script>";
                            }
                            $str="select * from info_distributor where d_status=1";
